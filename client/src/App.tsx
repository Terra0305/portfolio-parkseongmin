...
const PROJECTS = [
  {
    ...
    description:
      "조선대학교 SW중심대학사업단의 교내 Codeforces 경진대회 사이트를 팀원들과 함께 구축·운영했습니다. 저는 Azure VM, Docker, Nginx 기반 배포 인프라를 담당하며 프론트엔드와 백엔드 서비스를 분리 실행하고, 대회 운영에 필요한 참가 신청과 실시간 순위 확인 환경을 구성했습니다.",
    ...
    notion:
      "https://hallowed-second-cae.notion.site/CSforces-33cca50bf30d80f78ee4cdb9070df8a6?source=copy_link",
    press:
      "https://sw.chosun.ac.kr/main/menu?gc=934NPWN&do=view&bwrite_id=VMb3JyheK4Xq",
  ...
  },
  {
    ...
    role: "Backend",
    description:
      "현직 코딩 강사의 교육 현장 경험을 바탕으로 기획한 초급자용 알고리즘 시각화 웹 플랫폼입니다. 실제 학원 수업 환경에서 시범 활용하며 교육 현장 적용 가능성을 검증했고, 다중 접속 환경을 고려해 Spring Security + JWT 기반 Stateless 인증 구조를 설계했습니다.",
  ...
  },
  {
    ...
    description:
      "디지털 소외 계층을 위한 Google STT 및 Gemini LLM 기반 음성 예매 서비스. 비정형 음성 발화에서 예매 정보를 추출하고, 시스템이 처리 가능한 JSON 포맷으로 정규화하는 흐름을 설계했습니다.",
    ...
    notion:
      "https://www.notion.so/6-268ca50bf30d8046a487e201dc991d6b?source=copy_link",
  ...
  },
  {
    ...
    description:
      "멀티모달 AI 학습용 데이터 전처리. 수작업으로 진행되던 반복 자막 정제 과정을 Python 자동화 스크립트로 개선하고, 예외 처리와 로깅을 통해 대량 파일을 안정적으로 변환했습니다.",
    ...
    notion:
      "https://hallowed-second-cae.notion.site/GIST-MIT-273ca50bf30d8046b01ef222d90e9152",
...
const SKILLS = [
  ...
  {
    category: "Tools",
    items: ["GitHub", "Swagger", "JWT", "Gemini API", "Google STT"],
  },
];
...
function useScrollReveal() {
  useEffect(() => {
    ...
    document
      .querySelectorAll(".reveal, .divider-line")
  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "900px" }}>
        ...
        >
          문제를 해결하고, 배운 것을 나누는 개발자입니다.
          <br />
          꾸준한 알고리즘 학습과 서비스 개발로 두 차례 대상을 수상했으며,
          <br />
          현재 초등학생들에게 아두이노 코딩을 가르치고 있습니다.
        </p>
        <div
          ...
          <div>
            <InfoList
              ...
              items={[
                {
                  period: "2021.03 ~",
                  desc: "조선대학교 컴퓨터 공학과 재학 중",
                },
                {
                  period: "2022.04 ~ 2023.10",
                  desc: "대한민국 육군 병장 만기 전역",
                },
              ]}
            />
            <div style={{ marginTop: "2.5rem" }}>
              <InfoList
                ...
                items={[
                  {
                    period: "2026.07 ~ 진행중",
                    desc: "아두이노 코딩 교육 강사 (초등부)",
                  },
                  { period: "2026.07 ~ 진행중", desc: "ICT 빌드업 캠프 팀장" },
                  {
                    period: "2026.04 ~ 진행중",
                    desc: "조선대학교 SW중심대학사업단 교내 Codeforces 경진대회 구축 및 운영",
                  },
                  {
                    period: "2025.08 ~ 2025.10",
                    desc: "GIST-MIT 공동 연구, 외부 참여 연구원 (Research Assistant)",
                  },
                  {
                    period: "2025.07 ~ 2025.11",
                    desc: "호남 ICT 이노베이션 개발자 소그룹 팀빌딩 6기 팀장",
                  },
                ]}
              />
            </div>
...
function InfoList({
  ...
  title: string;
  items: { period: string; desc: string }[];
}) {
  return (
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        >
          <div>
            ...
            >
              Java와 SpringBoot를 중심으로 인증, API, 데이터 처리, 배포 흐름을
              경험했습니다. 알고리즘 학습으로 쌓은 문제 해결력을 바탕으로{" "}
              <strong>코드가 실제 서비스로 운영되는 과정</strong>까지 넓혀가고
              있습니다.
            </p>
          </div>
          <div>
        ...
        <div>
          ...
          >
            <span
              ...
              style={{ fontSize: "0.72rem", color: "var(--gray-text)" }}
            >
              {project.id}
            </span>
            <span
        ...
        >
          {"notion" in project && project.notion && (
            <a
              ...
              className="github-btn link-hover-accent"
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        >
          <div>
            ...
            >
              기본기와 실행력을 바탕으로 성장하는 백엔드 개발자가 되겠습니다.
              <br />더 궁금한 점이 있다면 편하게 연락 주세요.
            </p>
          </div>
          <div
            className="reveal reveal-delay-2"
          ...
          >
            {[
              ...
              {
                href: "https://github.com/Terra0305",
                label: "github.com/Terra0305",
                target: "_blank",
                icon: (
                  <svg
                    width="15"
...
function Footer() {
  return (
    ...
    >
      ...
      >
        © 2026 PARKSUNGMIN. Backend Developer.
      </span>
      <span
        style={{
          width: "1.2rem",
